...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sequence-data-s3-prefix", type=str, default="s3://api.blackhole2.ai.innopolis.university:443/pershin-medailab/pershin-medailab/EHR_Risk_Profiling/EHRSHOT/ehrshot_multiseed_inputs/ehrshot_sequence_datasets_compression_v2", help="S3/MinIO prefix with <task>/<version>/examples.parquet and vocab.json")
    ...
    parser.add_argument("--task", choices=["guo_readmission", "guo_icu"])
    parser.add_argument("--version")
    parser.add_argument("--model", choices=["GRU_1L", "GRU_2L", "LSTM_1L", "LSTM_2L", "RETAIN_lite"])
